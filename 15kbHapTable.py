...
def addreads(read_dict, not_found_reads, rf2, bf1, file2clusters):
    rowslist = []
    ...
    for read in not_found_reads:
        ...
        try:
            rowdict['c5c6_seq'] = rf2.loc[read]['Sequence']
        except:
            pass
...
#     readsfile2 = '19pB8_c3c4.csv'
    basesfile1 = '1pB8_c1c2c3c4.tsv'
    basesfile2 = 'Bases_1pB8_c5c6_seqIDs.csv'
    readsfile2 = '1pB8_c5c6.csv'


    chrom_block = basesfile2.split('_')[1]
    file1clusters = basesfile1.split('_')[1]
    ...
    for index, row in bf1.iterrows():
        ...
        if readname in read_dict:
            ...
            row['c5c6_seq'] = rf2.loc[readname]['Sequence']
    ...
    bf1 = addreads(read_dict, not_found_reads, rf2, bf1, file2clusters)

    bf1 = bf1[['Reads', 'c1c2_seq', 'c3c4_seq', 'c5c6_seq', 'c1c2', 'c3c4', file2clusters]]
